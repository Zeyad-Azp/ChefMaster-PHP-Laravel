...
<<<<<<< HEAD
    <section class="page-section" id="sectionHome" style="padding-top: 20px;">
        <div class="section-hero" style="margin-bottom: 40px; text-align: center;">
            ...
            @auth
            <a href="{{ route('recipes.create') }}" class="btn btn-primary" style="font-size: 1.1rem; padding: 12px 24px; border-radius: 30px; box-shadow: 0 4px 15px rgba(46, 204, 113, 0.3); text-decoration: none;">
            ...
            @else
            <a href="{{ route('login') }}" class="btn btn-primary" style="font-size: 1.1rem; padding: 12px 24px; border-radius: 30px; box-shadow: 0 4px 15px rgba(46, 204, 113, 0.3); text-decoration: none;">
